...
<div id="accordion">
    ...
    <div align="center">
        <img alt=""
             src='scoreAnalyzeFive.action?gradeID=<s:property value="gradeID"/>&courseID=<s:property value="courseID"/>&xueqi=<s:property value="xueqi"/>&examType=<s:property value="examType"/>'
