    ...
    <div align="center">
        ...
        <form action="teacherScoreModifySuc.action" method="post" id="form1">
            <table class="datalist table">
                ...
                <s:iterator value="idNameScores" status="st">
                    ...
                    <s:if test="#st.Even">
                        <tr class="altrow">
                            ...
                            <td><input type="text" name="scores" value='<s:property value="score" />'/></td>
                        </tr>
                    </s:if>
                    <s:else>
                        <tr>
                ...
                <tr>
                    <td colspan="4"><input type="button" name="saveScore" value="保存-修改"/>&nbsp;&nbsp;&nbsp;&nbsp;<input
                            type="button" value="取消-修改"/></td>
                </tr>
            </table>
