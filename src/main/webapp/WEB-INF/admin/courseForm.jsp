...
<body>
<jsp:include page="courseServiceNavigation.jsp">
    <jsp:param name="menuChildCode" value="20"></jsp:param>
</jsp:include>
<div id="accordion">
    <h3>课程管理&nbsp;&gt;&nbsp;课程信息添加&nbsp;&nbsp;
...
<div id="dialog" title="选择删除">
    <form id="form2" name="form2" method="post" action="courseDelete.action">
