...
<div id="accordion">
    ...
    <div align="center">
        ...
        <br>
        <img alt=""
             src='scoreVariationLine.action?gradeID=<s:property value="grade.bianHao" />&courseID=<s:property value="course.bianHao" />&examTime=<s:property value="examTime" />&examType=<s:property value="examType" />&xueqi=<s:property value="xueqi" />&year=<s:property value="grade.year" />&classID=<s:property value="grade.classID" />'
