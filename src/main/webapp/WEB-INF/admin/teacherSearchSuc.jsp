...
<div id="accordion">
    ...
    <div align="center" class="frame">
        <form action="teacherSearchSuc.action" method="get" id="myForm">
            <strong>请输入完整的<span style="color:red">教师编号</span>：</strong><input type="text" name="teacherBianHao"
                                                                              value='<s:property value="teacherBianHao" />'/>&nbsp;&nbsp;&nbsp;<input
        ...
        <table cellspacing="0" cellpadding="8" class="datalist table">
            ...
            <tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';">
                ...
                <td><a href="teacherModify.action?teacherBianHao=<s:property value="teacher.bianHao"/>"><input
                        type="button" value="修改"/></a>&nbsp;&nbsp;<a
                        href="teacherSeeing.action?teacherBianHao=<s:property value="teacher.bianHao"/>"><input
                        type="button" value="查看"/></a>&nbsp;&nbsp;<a
                        href='teacherDelete.action?bianHao=<s:property value="teacher.bianHao"/>'
                        onclick="return confirm('确定删除吗');"><input type="button" value="删除"/></a></td>
            </tr>
        </table>
    </div>
</div>
