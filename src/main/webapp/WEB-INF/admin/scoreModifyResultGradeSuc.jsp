...
<div id="accordion">
    <h3>成绩管理——成绩修改成功</h3>
    <div align="center">
        <s:property value="grade.year"/>届（<s:property value="grade.classID"/>）班所有学生第<s:property
            value="xueqi"/>学期<s:property value="examType"/>考试成绩<span>修改成功</span>
        <hr>
        <table class="datalist table">
            ...
            <s:iterator value="stuXueHaos" status="st">
                <tr>
                    <td><s:property/></td>
                    <td><s:property value="stuNames[#st.index]"/></td>
                    <td><s:property value="scores[#st.index]"/></td>
                </tr>
            </s:iterator>
        </table>
        <hr>
