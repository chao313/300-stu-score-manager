        ...
        <form action="scoreEnterSimpleStuSuc.action" id="form1" method="post">
            ...
            <table class="datalist table">
                ...
                <s:iterator value="courses">
                    <tr>
                        <td><input type="hidden" name="courseIDs" value='<s:property value="bianHao" />'/> <input
                                type="hidden" name="courseNames" value='<s:property value="name" />'> <s:property
                                value="name"/></td>
                        <td><input type="text" name="scores" value="0"/><span class="ErrorStyle"></span></td>
                    </tr>
                </s:iterator>
                <tr>
                    <td colspan="2"><input type="button" name="saveScore" value="保存成绩"/>&nbsp;&nbsp;&nbsp;<input
