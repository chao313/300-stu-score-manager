...
<body>
<div>
    <jsp:include page="gradeServiceNavigation.jsp">
        <jsp:param name="menuChildCode" value="30"></jsp:param>
    </jsp:include>
</div>
<div id="accordion">
    <h3>班级管理&nbsp;&gt;&nbsp;班级信息添加&nbsp;&nbsp;
            ...
            <form id="form1" name="form1" method="post" action="gradeSetUpRegister.action">
                <table class="datalist table">
                    <tr>
                        ...
                        <td><input type="text"
                                   name="grade.bianHao" id="bianHao" readonly="readonly" class="inputStyle"/> <input
                                type="button"
                    ...
                    <tr>
                        ...
                        <td><input type="text"
                                   name="grade.year" id="year" value='<s:property value="maxYear"/>'
                                   class="inputStyle"/><span id="yearError" class="ErrorStyle"></span></td>
                    </tr>
                    <tr>
                        <th align="right"><strong>班级序号</strong></th>
                        <td><input type="text"
                                   name="grade.classID" id="classID" value='<s:property value="classesCount"/>'
                                   class="inputStyle"/><span id="classIDError" class="ErrorStyle"></span></td>
                    </tr>
                    <tr>
