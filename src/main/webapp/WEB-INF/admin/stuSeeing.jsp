...
<div id="accordion">
    ...
    <div align="left">
        ...
        <hr>
        <img alt=""
             src='scoreAnalyze.action?stuXueHao=<s:property value="xuehao" />&stuName=<s:property value="student.name" />&year=<s:property value="grade.year" />&classID=<s:property value="grade.classID"/>'
