...
<body>
<div>
    <jsp:include page="teacherServiceNavigation.jsp">
        <jsp:param name="menuChildCode" value="10"></jsp:param>
    </jsp:include>
</div>
<div id="accordion">
    <h3>教师管理&nbsp;&gt;&nbsp;教师信息添加&nbsp;&nbsp;<span style="color:#000;">(目前已有<s:property value="count"/>名教师注册)</span>
    </h3>
    <div align="center">
            ...
            <table class="datalist">
                <tr>
                    ...
                    <td width="419"><label for="bianHao"></label> <input
                            type="text" name="teacher.bianHao" id="bianHao" readonly="readonly"/><span
                            class="flag">*</span> <input type="button" class="autoExec" value="自动激活"/><span
                ...
                <tr>
                    ...
                    <td><label for="name"></label> <input type="text" name="teacher.name"
                                                          id="name"/><span class="flag">*</span><span id="nameError"
                ...
                <tr>
                    ...
                    <td><label for="textfield"></label> <input type="text"
                                                               name="teacher.idCard" id="idCard"/><span
                ...
                <tr>
                    ...
                    <td><label for="jobTime"></label> <input type="text"
                                                             name="teacher.jobTime" id="jobTime"
                                                             value='<s:property value="now"/>'/><span
                ...
                <tr>
                    ...
                    <td width="327"><label for="password"></label> <input
                            type="text" name="teacher.password" id="password"/><span class="flag">*</span><input
                ...
                <tr>
                    ...
                    <td><label for="address"></label> <input name="teacher.address"
                                                             type="text" id="address" size="50"/><span
                ...
                <tr>
                    ...
                    <td><label for="textfield2"></label> <input type="text"
                                                                name="teacher.phone" id="phone"/><span
                            class="flag">*</span>
