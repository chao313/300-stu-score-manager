...
<div id="accordion">
    <h3><s:property value="grade.year"/>届（<s:property value="grade.classID"/>）班级第<s:property
            value="xueqiChose"/>学期授课安排</h3>
    <div class="frame">
        <form action="teachingArrangeFormRegister.action" method="post">
            <table class="datalist">
                ...
                <tr>
                    ...
                    <td colspan="2" align="center"><input type="submit" value="注册"/> <input type="reset" value="取消"/>
                    </td>
                </tr>
            </table>
        </form>
