...
<div id="accordion">
    ...
    <div align="center">
        <strong><s:property value="grade.year"/>届（<s:property value="grade.classID"/>）班<s:property
                ...
                value="course.name"/>科目成绩修改界面</strong>
        <hr>
        <form action="scoreModifyResultSuc.action" method="post" id="form1">
            <table class="datalist table">
                ...
                <tr>
                    <th>新的成绩：</th>
                    <td><input type="text" name="newScore" value="0"/></td>
                </tr>
                <tr>
                    <td colspan="2"><input type="button" name="saveScore" value="保存-修改"/><input type="button"
                                                                                                value="取消-修改"/></td>
                </tr>
            </table>
