...
<body>
<div>
    <jsp:include page="stuServiceNavigation.jsp">
        <jsp:param name="menuChildCode" value="00"></jsp:param>
    </jsp:include>
</div>
<div id="accordion">
    <h3>学生管理&nbsp;&gt;&nbsp;学生信息添加&nbsp;&nbsp;<span style="color:#000;">(目前已有<s:property value="count"/>名学生注册)</span>
    </h3>
    <div align="center">
            ...
            <table class="datalist">
                <tr>
                    ...
                    <td width="380"><label for="name"></label> <input type="text"
                                                                      name="student.name" id="name"/><span class="flag">*</span><span
                ...
                <tr>
                    ...
                    <td><label for="password"></label> <input type="text"
                                                              name="student.password" id="password"/><span class="flag">*</span>
                        <input type="button"
                               name="randomPass" id="randomPass" class="randomPass" value="产生随机密码"/><span
                                id="passwordError" class="ErrorStyle"></span></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><label for="idCard"></label> <input type="text"
                                                            name="student.idCard" id="idCard"/><span
                ...
                <tr>
                    ...
                    <td><label for="address"></label> <input name="student.address"
                                                             type="text" id="address" size="40"/><span
