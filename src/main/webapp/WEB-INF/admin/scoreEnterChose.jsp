...
<jsp:include page="scoreServiceNavigation.jsp">
    <jsp:param name="menuChildCode" value="40"></jsp:param>
</jsp:include>
<div id="accordion">
    <h3>成绩管理——成绩录入</h3>
        ...
        <form action="scoreEnterSimpleStu.action" method="post" id="stuForm">
            <table class="datalist">
                <tr>
                    ...
                    </select>&nbsp;&nbsp;&nbsp;考试类型： <select name="examType" id="examType1">
                        <option value="期中">期中</option>
                        <option value="期末">期末</option>
                    </select>&nbsp;&nbsp;&nbsp;<input type="button" name="stuBtn" value="下一步"/></td>
                </tr>
            </table>
        </form>
            ...
            <table class="datalist">
                <tr>
                    <td>选择班级：<select name="gradeID">
                        ...
                        <option value="期中">期中</option>
                        <option value="期末">期末</option>
                    </select>&nbsp;&nbsp;&nbsp;<input type="button" value="下一步" name="nextBtn"/></td>
                </tr>
            </table>
        </form>
