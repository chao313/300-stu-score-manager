            ...
            <table class="datalist">
                <tr>
                    ...
                    <td width="430"><label for="name"></label> <input type="text"
                                                                      ...
                                                                      value='<s:property value="student.name" />'/><span
                            class="flag">*</span><span id="nameError" class="ErrorStyle"></span></td>
                </tr>

                <tr>
                    <th align="right" class="labelString"><strong>登录密码</strong></th>
                    <td><label for="password"></label> <input type="text"
                                                              name="student.password" id="password"
                                                              value='<s:property value="student.password" />'/><span
                            class="flag">*</span> <input type="button"
                                                         name="randomPass" id="randomPass" class="randomPass"
                                                         value="产生随机密码"/><span id="passwordError"
                                                                               class="ErrorStyle"></span></td>
                </tr>

                <tr>
                    <th align="right" class="labelString"><strong>性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别</strong>
                    </th>
                    <td><label for="sex"></label> <select name="student.sex" id="sex">
                        <option value="男"
                                <s:if test='student.sex == "男"'>selected="selected"</s:if> >男
                        </option>
                        <option value="女"
                                <s:if test='student.sex == "女"'>selected="selected"</s:if> >女
                        </option>
                ...
                <tr>
                    ...
                    <td><label for="idCard"></label> <input type="text"
                                                            name="student.idCard" id="idCard"
                                                            value='<s:property value="student.idCard" />'/><span
                ...
                <tr>
                    ...
                    <td><label for="address"></label> <input name="student.address"
                                                             type="text" id="address" size="50"
                                                             value='<s:property value="student.address" />'/><span
                            class="flag">*</span><span id="addressError" class="ErrorStyle"></span></td>
                </tr>

                <tr>
                    <th width="80" align="right" class="labelString"><strong>民&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;族</strong>
                    </th>
                    <td><label for="nation"></label> <select name="student.nation"
                                                             id="nation">
                        <option value="汉族"
                                <s:if test="student.nation=='汉族'">selected="selected"</s:if> >汉族
                        </option>
                        <option value="少数民族"
                                <s:if test="student.nation=='少数民族'">selected="selected"</s:if> >少数民族
                        </option>
                    </select><span class="flag">*</span></td>
                </tr>
                <tr>
                    <th width="80" align="right" class="labelString">
                        <strong>分配班级</strong>
                    </th>
                    <td>
                        <select name="student.classID">
                            <s:iterator value="grades">
                                <option value='<s:property value="bianHao"/>'
                                        <s:if test="student.classID==bianHao">selected="selected"</s:if> ><s:property
                ...
                <tr>
                    ...
                    <td><label for="polStat"></label> <select name="student.polStat"
                                                              id="polStat">
                        <option value="中共党员"
                                <s:if test="student.polStat=='中共党员'">selected="selected"</s:if> >中共党员
                        </option>
                        <option value="中共预备党员"
                                <s:if test="student.polStat=='中共预备党员'">selected="selected"</s:if> >中共预备党员
                        </option>
                        <option value="共青团员"
                                <s:if test="student.polStat=='共青团员'">selected="selected"</s:if> >共青团员
                        </option>
                        <option value="无党派人士"
                                <s:if test="student.polStat=='无党派人士'">selected="selected"</s:if> >无党派人士
                        </option>
                        <option value="普通公民"
                                <s:if test="student.polStat=='普通公民'">selected="selected"</s:if> >普通公民
                        </option>
                        <option value="港澳同胞"
                                <s:if test="student.polStat=='港澳同胞'">selected="selected"</s:if>  >港澳同胞
                        </option>
                        <option value="其它"
                                <s:if test="student.polStat=='其它'">selected="selected"</s:if> >其它
                        </option>
                    </select><span class="flag">*</span></td>
                </tr>
                <tr>
                    ...
                    <td><label for="schoolTime"></label> <input type="text"
                                                                name="student.schoolTime" id="schoolTime"
                                                                value='<s:property value="student.schoolTime" />'/><span
                            class="flag">*</span><span id="schoolTimeError" class="ErrorStyle"></span></td>
                </tr>
                <tr>
                    ...
                    <td><label for="houseHold"></label> <select name="student.houseHold"
                                                                id="houseHold">
                        <option value="农村"
                                <s:if test="student.houseHold=='农村'">selected="selected"</s:if> >农村
                        </option>
                        <option value="城市"
                                <s:if test="student.houseHold=='城市'">selected="selected"</s:if> >城市
                        </option>
                    </select><span class="flag">*</span></td>
                </tr>
                <tr>
                    ...
                    <td><label for="schoolMethod"></label> <select
                        ...
                        <option value="寄宿生"
                                <s:if test="student.schoolMethod=='寄宿生'">selected="selected"</s:if> >寄宿生
                        </option>
                        <option value="走读生"
                                <s:if test="student.schoolMethod=='走读生'">selected="selected"</s:if> >走读生
                        </option>
                    </select><span class="flag">*</span></td>
