...
<div>
    <jsp:include page="stuServiceNavigation.jsp">
        <jsp:param name="menuChildCode" value="02"></jsp:param>
    </jsp:include>
</div>
<div id="accordion">
    <h3>学生管理&nbsp;&gt;&nbsp;学生信息查询</h3>
    <div align="center" class="frame">
        <form action="" method="get" id="myForm">
            <strong>请输入完整的<span style="color:red">学生学号</span>：</strong><input type="text" name="stuXueHao"
                                                                              value='<s:property value="stuXueHao" />'/>&nbsp;&nbsp;&nbsp;<input
        ...
        <table cellspacing="0" cellpadding="8" class="datalist">
            ...
            <tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';">
                ...
                <td><a href="stuModify.action?xuehao=<s:property value="simpleStudent.xuehao"/>"><input type="button"
                                                                                                        value="修改"/></a>&nbsp;&nbsp;<a
                        href="stuSeeing.action?xuehao=<s:property value="simpleStudent.xuehao"/>"><input type="button"
                                                                                                         value="查看"/></a>&nbsp;&nbsp;<a
                        href='stuDelete.action?xuehao=<s:property value="simpleStudent.xuehao"/>'
                        onclick="return confirm('确定删除吗，将会删除该学生所有的成绩记录？');"><input type="button" value="删除"/></a></td>
            </tr>
