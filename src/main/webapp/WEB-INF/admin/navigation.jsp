...
<div align="center">
    <a href="stuSearch.action"><button class="button"
            ...
            %>
            ><img alt="" src="image/stu.jpg" style="width: 120px;height: 30px;"></button></a>
    <a href="teacherSearch.action"><button class="button"
            ...
            %>
    ><img alt="" src="image/teacher.jpg" style="width: 120px;height: 30px;"></button></a>
    <a href="courseForm.action"><button class="button"
            ...
            %>
    ><img alt="" src="image/course.jpg" style="width: 120px;height: 30px;"></button></a>
    <a href="gradeSetUp.action"><button class="button"
            ...
            %>
    ><img alt="" src="image/grade.jpg" style="width: 120px;height: 30px;"></button></a>
