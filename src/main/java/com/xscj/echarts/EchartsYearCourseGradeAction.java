 ...
 */
public class EchartsYearCourseGradeAction extends ActionSupport {
    ...
    public String execute() throws Exception {
        List<List<Object>> avgByYearAndCourseids = echartsDao.getByYearAndCourseidAndGradeid(year, courseid, gradeid);
