 ...
 * @date
 */
public class EchartsPersonTotalYearGradeAction extends ActionSupport {
    ...
    public String execute() throws Exception {
        List<List<Object>> avgByYearAndCourseids = echartsDao.getPersonTotalByYearAndGradeid(year, gradeid);
