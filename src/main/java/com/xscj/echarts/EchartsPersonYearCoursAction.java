 ...
 * @date
 */
public class EchartsPersonYearCoursAction extends ActionSupport {
    ...
    public String execute() throws Exception {
        List<List<Object>> avgByYearAndCourseids = echartsDao.getPersonByYearAndCourseid(year, courseid);
